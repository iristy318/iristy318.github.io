...
function preload(){
  ...
  sound5 = loadSound('assets/CherryBomb.mp3');
...
function draw() {
  ...
  text("WITH",windowWidth/2-50,windowHeight/2+120);
  text("THE",windowWidth/2-50,windowHeight/2+120);
  text("BUBBLES",windowWidth/2-50,windowHeight/2+120);
